...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/ShadowCarder/StringSessionBot)
...
1. Clone the repo
   ```markdown
   https://github.com/ShadowCarder/StringSessionBot
   ```
